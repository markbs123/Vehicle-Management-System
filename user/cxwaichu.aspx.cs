...
public partial class user_cxwaichu : System.Web.UI.Page
{
    ...
    private void useridbind1()
    {
        ...
        sda.SelectCommand = new SqlCommand("select* from pcgl where comedate is null and  pcok='yes' and username='" + this.TextBox1.Text.ToString() + "'and ycdq+ycks='" + Convert.ToString(Session["dwdq+dwm"]) + "'", con);
    ...
    private void useridbind2()
    {
        ...
        sd.SelectCommand = new SqlCommand("select* from pcgl where comedate is null and  pcok='yes' and carid='" + this.TextBox2.Text.ToString() + "'and ycdq+ycks='" + Convert.ToString(Session["dwdq+dwm"]) + "'", con1);
