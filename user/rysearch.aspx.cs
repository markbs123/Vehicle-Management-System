...
public partial class user_rysearch : System.Web.UI.Page
{
    ...
    private void caridbind2()
    {
        ...
        sda.SelectCommand = new SqlCommand("select * from userinfo where area+department='" + Convert.ToString(Session["dwdq+dwm"]) + "'", con);
    ...
    {
        Server.Transfer("~/user/xzry.aspx");
    }
    protected void Button5_Click(object sender, EventArgs e)
    {
        Server.Transfer("~/user/cxry.aspx");
    }
}