<%@ Control Language="C#" AutoEventWireup="true" CodeFile="paicheinfo.ascx.cs" Inherits="user_paicheinfo" %>
<table style="width: 1135px; color: #ffffff; border-top-style: none; border-left-style: none; border-bottom-style: none; padding-right: 0px; padding-left: 0px; padding-bottom: 0px; margin: 0px; padding-top: 0px;" cellspacing="1">
                    <tr>
                        <td style="width: 180px; height: 16px; background-color: menu; text-align: center;">
                        ...
                        <td style="width: 65px; height: 16px; background-color: menu; text-align: center;">
