...
public partial class user_xzryedit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.Label2.Text = Convert.ToString(Session["dwdq+dwm"]);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con2.Open();
        string sql_update = "update userinfo set username='" + this.TextBox1.Text  + "',sex='" + this.DropDownList2.SelectedValue + "',birthday='" + this.Label1.Text + "',sfzno='" + this.TextBox5.Text + "',jszno='" + this.TextBox6.Text + "',phoneno='" + this.TextBox7.Text  + "',usualcar='" + this.TextBox9.Text + "' where id='" + Request.QueryString["id"] + "'";
