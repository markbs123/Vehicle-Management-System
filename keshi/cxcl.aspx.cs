...
public partial class keshi_cxcl : System.Web.UI.Page
{
    ...
    private void caridbind1()
    {
        ...
        {
            sda.SelectCommand = new SqlCommand("select* from carinfo where carnumber='" + this.TextBox1.Text.ToString() + "'and area='" + Convert.ToString(Session["yonghuname"]) + "'", con);
        }
    ...
    private void caridbind2()
    {
        ...
        else
        {
            ...
            sd.SelectCommand = new SqlCommand("select* from carinfo where enginenumber='" + this.TextBox2.Text.ToString() + "'and area='" + Convert.ToString(Session["yonghuname"]) + "'", con1);
        }
    ...
    private void caridbind3()
    {
        ...
        if (Convert.ToString(Session["yonghuname"]) == "定西市")
        {
            sda.SelectCommand = new SqlCommand("select* from carinfo where area+department='" + this.TextBox3.Text.ToString() + "'", con);
        }
        else
        {
            sda.SelectCommand = new SqlCommand("select* from carinfo where area+department='" + this.TextBox3.Text.ToString() + "'and area='" + Convert.ToString(Session["yonghuname"]) + "'", con);
        }
