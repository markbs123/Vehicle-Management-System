...
public partial class keshi_paicheinfo : System.Web.UI.Page
{
    ...
    private void caridallbind()
    {
        ...
        else
        {
            ...
            if (this.lblselect.Text == "1")
            {
                sda.SelectCommand = new SqlCommand("select* from pcgl where comedate is not null and username='" + this.TextBox5.Text.ToString() + "' and ycdq='" + Convert.ToString(Session["yonghuname"]) + "' and outdate Between'" + this.TextBox1.Text.ToString() + "' And  '" + this.TextBox2.Text.ToString() + "' order by outdate desc", con);
            }
            else
            {
                sda.SelectCommand = new SqlCommand("select* from pcgl where comedate is not null and carid='" + this.TextBox6.Text.ToString() + "' and ycdq='" + Convert.ToString(Session["yonghuname"]) + "' and outdate Between'" + this.TextBox3.Text.ToString() + "' And  '" + this.TextBox4.Text.ToString() + "' order by outdate desc", con);
            }
        }
