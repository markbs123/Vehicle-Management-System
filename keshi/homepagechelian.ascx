<%@ Control Language="C#" AutoEventWireup="true" CodeFile="homepagechelian.ascx.cs" Inherits="keshi_homepagechelian" %>
<style type="text/css">
    .style1
    {
        text-align: center;
...
<table cellspacing="1" style="border-style: none; width: 1135px; color: #ffffff; border-collapse: collapse;
    height: 20px; ">
    <tr>
        ...
        <td style="height: 16px; background-color: menu; text-align: center; width: 170px;">
